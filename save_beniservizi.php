...
$istruzione_sql= "INSERT INTO beniservizi(idFE, NumeroLinea, Descrizione, Quantita, UnitaMisura, PrezzoUnitario, 
PrezzoTotale, NumeroDdt, DataDdt, Note) 
VALUES('$info[0]','$info[1]','$info[2]','$info[3]','$info[4]','$info[5]','$info[6]','$info[7]',NULLIF('$info[8]',''),
'$info[9]')";
